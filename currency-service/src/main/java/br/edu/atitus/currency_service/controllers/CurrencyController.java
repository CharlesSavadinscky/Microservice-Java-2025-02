...
public class CurrencyController {
	...
	public CurrencyController(CurrencyRepository repository, CurrencyBCClient currencyBBClient, CacheManager cacheManager) {
		super();
		this.repository = repository;
		this.currencyBCClient = currencyBBClient;
